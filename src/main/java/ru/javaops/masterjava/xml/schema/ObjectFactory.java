...
public class ObjectFactory {
    ...
    private final static QName _GroupType_QNAME = new QName("http://javaops.ru", "GroupType");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaops.ru", name = "GroupType")
    public JAXBElement<String> createGroupType(String value) {
        return new JAXBElement<String>(_GroupType_QNAME, String.class, null, value);
    }
